# Commercial — Entity & Engagement Identification
...
- Confirm the engagement is an audit (opinion language, SAS-based reporting). If the document appears to be a review (SSARS AR-C 90), compilation (AR-C 80), or preparation engagement (AR-C 70), flag this — the report-language module procedures are scoped to audit reports.
